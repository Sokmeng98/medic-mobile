...
class MyHivTesting extends StatelessWidget {
  const MyHivTesting({super.key});
  ...
  Widget build(BuildContext context) {
    return Consumer<DarkModeProvider>(builder: (context, darkModeProvider, _) {
      ...
      return MaterialApp(
        ...
        home: const MyHivTestingScreen(title: "HIV Test"),
      );
    });
  }
}

class MyHivTestingScreen extends StatefulWidget {
  const MyHivTestingScreen({super.key, required this.title});

  final String title;

  @override
  State<MyHivTestingScreen> createState() => _MyHivTestingScreenState();
}

class _MyHivTestingScreenState extends State<MyHivTestingScreen> {
                      ...
                      child: FilledButton(
                        ...
                        onPressed: () {
                          ...
                          if (_formKey.currentState!.validate()) {
                            ...
                            HomeService().postHIVTestingAppointment(2, selectTime, dropdownValue);
                            _makeAppointment();
                          } else {
                            setState(() {
                              _hasError = true;
  ...
  Widget _selectFaciliy(isDarkMode) {
    return Container(
      decoration: BoxDecoration(
        color: Colors.white,
        borderRadius: BorderRadius.circular(20.0),
      ...
      child: ButtonTheme(
        ...
        child: DropdownButtonFormField(
          ...
          iconEnabledColor: isButtonPressed && dropdownValue == null ? Colors.red.shade900 : AppTheme.primary,
          borderRadius: BorderRadius.circular(20.0),
